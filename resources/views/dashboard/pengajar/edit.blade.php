    ...
    <div class="row">
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <input type="text" class="form-control" name="name" value="{{ old('name', $pengajar->name) }}" />
                        @error('name')
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <textarea class="form-control" name="description" id="content-description" rows="3">{{ old('description', $pengajar->description) }}</textarea>
                    @error('description')
                    <small class="form-text error-input">{{ $message }}</small>
                    @enderror
                </div>
