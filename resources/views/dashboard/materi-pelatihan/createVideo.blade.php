...
<form action="{{ route('dashboard.materi_pelatihan.storeVideo') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <input type="text" class="form-control" name="link_media" placeholder="Masukkan link video"/>
                        @error('link_media')
