...
<form action="{{ route('dashboard.materi_pelatihan.updateVideo', $materi->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">File Video</h6>
                </div>
                <div class="card-body">
                    <div class="col-md-12">
                        <div class="form-group">
                            <input type="text" class="form-control" name="link_media" value="{{ $materi->link_media }}" />
                            @error('link_media')
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Judul Video</h6>
                </div>
                <div class="card-body">
                    <div class="form-group">
