...
<form action="{{ route('dashboard.kategori_pengajar.update', $kategori_pengajar->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <input type="text" class="form-control" name="kategori_pengajar" value="{{ old('kategori_pengajar', $kategori_pengajar->kategori_pengajar) }}" />
