    ...
    <div class="row">
        <div class="col-xl-8 col-lg-7">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="price" value="{{ old('price', $produk->price) }}" data-mask />
                        </div>
                        @error('price')
                        <small class="form-text error-input">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="stock" value="{{ old('stock', $produk->stock) }}" min="0" />
                        @error('stock')
                        <small class="form-text error-input">{{ $message }}</small>
                        @enderror
                    </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <textarea id="content-produk" name="description">{{ old('description', $produk->description) }}</textarea>
                    @error('description')
                    <small class="form-text error-input">{{ $message }}</small>
                    @enderror
                </div>
...
@section('extra-js')
<script src="{{ asset('_dashboard/js/jquery.inputmask.bundle.min.js') }}"></script>
<script>
    var useDarkMode = window.matchMedia('(prefers-color-scheme: dark)').matches;
    tinymce.init({
        selector: 'textarea#content-produk',
