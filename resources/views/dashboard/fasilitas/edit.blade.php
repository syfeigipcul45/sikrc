...
<form action="{{ route('dashboard.fasilitas.update', $fasilitas->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <input type="text" class="form-control" name="name" value="{{ old('name', $fasilitas->name) }}" />
                        @error('name')
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <textarea id="content-fasilitas" name="description">{{ old('description', $fasilitas->description) }}</textarea>
                    @error('description')
                    <small class="form-text error-input">{{ $message }}</small>
                    @enderror
                </div>
...
<script>
    ...
    tinymce.init({
        selector: 'textarea#content-fasilitas',
